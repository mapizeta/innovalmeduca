...
<form name="Me" method="post" action="ver_envio_01.php">
Título<input type="text" name="text_titulo" size="60" class="fuente">
	<h1>
...
else
{
	...
	<div align="center"><input type="submit" name="submit_agregar" value="Agregar" onClick=""></div>
</form>
</body>
</html>
