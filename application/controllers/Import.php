...
class Import extends CI_Controller {
	...
	public function puntaje_view()
	{
		$this->load->view('import/puntaje');	
	}
...
////////////////////////////////////////////////////////
		if (file_exists ("bak_".$archivo)){ 
			...
			for ($i=2;$i<=81;$i++){
				...
				*/	
				...
				$_DATOS_EXCEL[$i]['correcta'] = $objPHPExcel->getActiveSheet()->getCell('J'.$i)->getCalculatedValue();
		...
		foreach($_DATOS_EXCEL as $campo => $valor){
			...
			$data_pregunta=array(
	    			...
	    			'id_sub_sector'=>1,//lenguaje=2, matematicas=1
	    			'id_nivel'=>2
	    			);
			...
			if($this->import_prueba->insert_pregunta($data_pregunta, $data_respuesta, $CORRECTA));
