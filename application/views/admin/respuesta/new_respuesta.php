...
$(document).ready(function() {
	...
	/*
	$.ajax({
            url:'<?php echo site_url();?>/respuesta/verificar_resp_cor/'+id_pregunta,
...
{	
	...
	//console.log($("form").serialize());
		...
		$.post("<?php echo site_url();?>/respuesta/save" , $("form").serialize(), 
	        function(data){
	        	alert(data.mensaje);
...
<div class="modal-header modal-comun">
        ...
        <h4 class="modal-title modal-title-comun"><b>Crear Alternativa</b></h4>
...
<div class="modal-footer">
    ...
    <a id="enviar" href="#" class="btn btn-crear">Crear</a>
</div>
