...
<html lang="en">
	...
	<body>
			...
			<div class="sidebar app-aside" id="sidebar">
				<div class="sidebar-container perfect-scrollbar">
					<nav>
						...
						<?php
							/*Menu botones*/
							$this->load->view('partial/menu_profesor_filtro');
						?>	
		...
		<div class="navbar-collapse collapse" >
				<div class="inner-addon left-addon" style="float: left;position: relative;width: 747px; margin-top: 16px;"> 
			           		<i class="glyphicon glyphicon-search" style="margin-top: -3px;"></i>
			            	<input type="text" name="filtro" id="filtro" placeholder="Buscar" autofocus="" style="width: 77%;">
			        	</div>									
