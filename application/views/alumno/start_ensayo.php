		...
		<div id="app">
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-4x btn"> <i class="fa fa-square fa-stack-2x text-red"></i> <i class="fa fa-pencil-square fa-stack-1x fa-inverse "></i> </span>
											<h2 class="StepTitle">Iniciar Ensayo</h2>
											<p class="text-small">
			...
			<script type="text/javascript">
				$('.btn').on('click', function () 
					{
      					window.location.href = "<?php echo base_url().'index.php/alumno/action_prueba/'.$id_ensayo.'/inicio'; ?>";
    				});
			</script>	